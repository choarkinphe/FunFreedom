...
//            .show()
    ...
    @IBAction func sheet(_ sender: Any) {
        ...
        FunFreedom.sheet.addActions(titles: ["Music0","Music1","Music2","Music3","Music4","Music5","Music6","Music7"]).resultActions(actions).selectType(.multi).multiHandler({ (actions) in
